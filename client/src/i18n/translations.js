  ...
  en: {
    ...
    settings: {
      ...
      apiKey: {
        ...
        quickStart: {
          title: 'Quick Start - Shared API Keys',
          description: 'Click any button below to instantly activate a shared key. The key will be saved automatically and kept hidden for security. Note: These keys are shared among users and may have slower response times due to API rate limits.',
        },
        ownKey: {
  ...
  id: {
    ...
    settings: {
      ...
      apiKey: {
        ...
        quickStart: {
          title: 'Mulai Cepat - API Key Bersama',
          description: 'Klik tombol mana pun di bawah untuk langsung mengaktifkan key bersama. Key akan disimpan secara otomatis dan disembunyikan untuk keamanan. Catatan: Key ini dibagikan di antara pengguna dan mungkin memiliki waktu respons yang lebih lambat karena batas API.',
        },
        ownKey: {
